async function search(a) {
    let t = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=f52c9503e6a94ccaa2c152919241112&q=${a}&days=3`);
    ...
    if (null != t) {
        ...
        let n = `<div class="today forecast">
                    ...
                    <div class="forecast-content" id="current">
                        ...
                        <div class="degree"><div class="num">${t.temp_c}<sup>o</sup>C</div>
                        <div class="forecast-icon"><img src="https:${t.condition.icon}" alt="" width=90></div></div><div class="custom">${t.condition.text}</div>
